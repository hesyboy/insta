    ...
    <a href="{{route('site.product')}}" class="relative bg-white rounded-box p-3 flex flex-col gap-5 w-68 group">
        ...
        <div class="overflow-hidden transition-all duration-500 flex flex-col text-white  items-center
         ...
         p-3 rounded-xl relative">
            ...
            <div class="flex flex-col w-full gap-2 bg-black/20 mt-3 mb-2 rounded-xl p-2 ">
            ...
            <div class="flex flex-col w-full gap-2 bg-black/20 mb-2 rounded-xl p-2 ">
                <div class="flex justify-between px-2">
                    <div class="text-xs">
                         مدت گارانتی خرید :                    </div>
                    <div class="text-xs">
                        10 روز
                    </div>
                </div>
...
{{--
        ...
        <div class="absolute -top-2 -left-2 w-full flex justify-end">
            <div class="bg-white rounded-xl shadow-lg px-2 py-1 font-semibold text-sm">
                کد : 35#
            </div>
        </div>
