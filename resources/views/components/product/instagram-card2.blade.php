<div>
    <a href="{{route('site.product')}}" class="relative bg-white rounded-box p-3 flex flex-col gap-3 w-68 group hover:scale-95 transition-all duration-300">


        <div class=" transition-all duration-500 flex flex-col text-white  items-center
         bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600
         p-3 rounded-xl relative pt-3">
...
{{--
        ...
        <div class="px-2">
            <h3 class="font-semibold">خرید پیج اینستاگرام کاملا ایرانی</h3>
        </div>


        <div class="w-full flex gap-3 justify-between">
            <div class="flex flex-col w-1/3 items-center bg-gray-100 text-gray-600 p-1 rounded-xl  font-semibold">
        ...
        <div class="flex flex-col w-full gap-4 bg-white text-gray-600  rounded-xl font-semibold ">
            <div class="grid grid-cols-3 gap-3">
                <div class="text-xs bg-gray-100 text-gray-600  rounded-xl p-2 text-center">
                    فرهنگ و هنر
                </div>
                <div class="text-xs bg-gray-100 text-gray-600  rounded-xl p-2 text-center">
                    کاملا واقعی
            ...
            <div class="flex justify-between items-center">
                <div class="text-sm bg-gradient-to-r from-indigo-600 hover:from-indigo-700 via-purple-600 to-pink-600 hover:to-pink-700 text-gray-100  rounded-xl p-2 font-medium">
